 ...
 * Includes user profile fields for personalization
 */
...
export const user = pgTable("user", {
  ...
  pythonKnowledge: boolean("python_knowledge").notNull().default(false),
  hasNvidiaGpu: boolean("has_nvidia_gpu").notNull().default(false),
